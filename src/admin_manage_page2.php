...
<html>
	...
	<body class="vh-100" style="background-color: #18318b">
		...
		<div class="container col-lg-10 shadow-lg rounded text-white" style="margin-top: 200px; position: relative; margin-bottom: 150px; background-image: url(assets/img/test.jpg); background-position: center; background-size: cover;">
