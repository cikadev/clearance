...
INSERT INTO `activity` VALUES (1,'Completing Defense',1,'2020-05-20 00:00:00','2020-05-20 00:00:00'),(2,'Graduation Payment',2,'2020-05-20 00:00:00','2020-05-20 00:00:00'),(3,'Library Clearance',3,'2020-05-20 00:00:00','2020-05-20 00:00:00'),(4,'Toga Config',1,'2020-06-13 10:32:05','2020-06-13 10:32:05');
...
INSERT INTO `activity_requirement` VALUES (1,4,2,'2020-05-20 00:00:00','2020-06-13 10:32:35'),(2,3,2,'2020-05-20 00:00:00','2020-05-20 00:00:00');
...
INSERT INTO `card` VALUES (1,'001201300034',1,'2020-05-20 00:00:00','2020-05-20 00:00:00'),(2,'001201400056',2,'2020-05-20 00:00:00','2020-05-20 00:00:00'),(3,'001201400012',3,'2020-05-20 00:00:00','2020-05-20 00:00:00');
...
INSERT INTO `cs_status` VALUES (1,'Uncheck','2020-05-20 00:00:00','2020-05-20 00:00:00'),(2,'Checked','2020-05-20 00:00:00','2020-05-20 00:00:00');
...
INSERT INTO `department` VALUES (1,'Faculty','Cubicle','2020-05-20 00:00:00','2020-05-20 00:00:00'),(2,'Finance','Finance Dept.','2020-05-20 00:00:00','2020-05-20 00:00:00'),(3,'Library','Adam Kurniawan','2020-05-20 00:00:00','2020-05-20 00:00:00');
...
INSERT INTO `prodi` VALUES (1,'CIT - Information Technology Study Program','2020-05-20 00:00:00','2020-05-20 00:00:00'),(2,'EEN  Electrical Engineering Study Program','2020-05-20 00:00:00','2020-05-20 00:00:00'),(3,'IEN  Industrial Engineering Study Program','2020-05-20 00:00:00','2020-05-20 00:00:00');
...
INSERT INTO `puis_student` VALUES (1,'I Made Primayana Martha','primamartha@gmail.com',2013,'1995-11-09','2018-07-01',1,1,'2020-05-20 00:00:00','2020-06-01 10:32:37','001'),(2,'Alpinta Harjanto','primamartha@gmail.com',2014,'1996-06-25','2018-05-12',2,2,'2020-05-20 00:00:00','2020-06-01 10:32:37','002'),(3,'Andre Leo','andreleo2604@gmail.com',2014,'1996-04-26','2020-01-06',3,2,'2020-05-20 00:00:00','2020-06-01 10:32:37','003');
...
INSERT INTO `puis_student_activity` VALUES (13,1,'',1,4,'2020-06-02 15:37:48','2020-06-13 13:29:01'),(31,1,'',2,4,'2020-06-13 10:46:14','2020-06-13 10:46:14'),(36,2,'',2,4,'2020-06-13 10:57:01','2020-06-13 10:57:01'),(45,2,'',1,4,'2020-06-24 16:55:27','2020-06-24 16:55:27');
...
--
-- Table structure for table `puis_student_toga_size`
--

DROP TABLE IF EXISTS `puis_student_toga_size`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `puis_student_toga_size` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `puis_student_toga_size_puis_student_id_uindex` (`puis_student_id`),
  KEY `puis_student_toga_size_toga_size_id_fk` (`toga_size_id`),
  CONSTRAINT `puis_student_toga_size_puis_student_id_fk` FOREIGN KEY (`puis_student_id`) REFERENCES `puis_student` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `puis_student_toga_size_toga_size_id_fk` FOREIGN KEY (`toga_size_id`) REFERENCES `toga_size` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `puis_student_toga_size`
--

LOCK TABLES `puis_student_toga_size` WRITE;
/*!40000 ALTER TABLE `puis_student_toga_size` DISABLE KEYS */;
/*!40000 ALTER TABLE `puis_student_toga_size` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `roles` (
  ...
  `updated_at` datetime NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `roles_role_uindex` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `roles` VALUES (1,'admin','2020-05-20 00:00:00','2020-05-20 00:00:00'),(2,'staff','2020-05-20 00:00:00','2020-05-20 00:00:00');
...
INSERT INTO `toga_size` VALUES (1,'M','2020-05-20 00:00:00','2020-05-20 00:00:00'),(2,'L','2020-05-20 00:00:00','2020-05-20 00:00:00'),(3,'XL','2020-05-20 00:00:00','2020-05-20 00:00:00');
...
INSERT INTO `user` VALUES (4,'admin','admin@example.com','$pbkdf2-sha512$25000$NsbYG6OUMoZwDuEcY6xVCg$hr8hr1dsDhLw9ZItU6Dn5oi8gKJCxVTabbxAiOou6trospeR8Hh7Y0/phCU2T2gWDxnC5PBSbj9QfrRiiQqvQw',1,1,'2020-05-31 12:00:56','2020-05-31 05:01:07'),(5,'imouto','imouto@example.com','$pbkdf2-sha512$25000$3ft/z3lvbc3Z2xtD6D0npA$SfXW/ljT45lYixmrpYNKcbR06zWiWXqam2V6/Dn6pMqFSt1OXi.XrzNt8zE4T55WuR4FNVYfNG.70zzMwD3Q8Q',1,2,'2020-05-31 12:00:56','2020-06-24 16:52:13');
/*!40000 ALTER TABLE `user` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `user-prodi_constraint`
--

DROP TABLE IF EXISTS `user-prodi_constraint`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user-prodi_constraint` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `prodi_id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_index` (`user_id`,`prodi_id`),
  KEY `user-prodi_constraint_prodi_id_fk` (`prodi_id`),
  CONSTRAINT `user-prodi_constraint_prodi_id_fk` FOREIGN KEY (`prodi_id`) REFERENCES `prodi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `user-prodi_constraint_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `user-prodi_constraint`
--

LOCK TABLES `user-prodi_constraint` WRITE;
/*!40000 ALTER TABLE `user-prodi_constraint` DISABLE KEYS */;
INSERT INTO `user-prodi_constraint` VALUES (1,1,5,'2020-06-24 16:38:59','2020-06-24 16:38:59');
/*!40000 ALTER TABLE `user-prodi_constraint` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-06-25  0:02:16
